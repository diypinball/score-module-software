...
void sendScore(uint8_t priority) {
	...
	transmitObj.dlc = 4;
	transmitObj.data[0] = boardScore.scoreBytes[3];
	transmitObj.data[1] = boardScore.scoreBytes[2];
	transmitObj.data[2] = boardScore.scoreBytes[1];
	transmitObj.data[3] = boardScore.scoreBytes[0];
...
void setScore(uint8_t data[]) {
	boardScore.scoreBytes[0] = data[3];
	boardScore.scoreBytes[1] = data[2];
	boardScore.scoreBytes[2] = data[1];
	boardScore.scoreBytes[3] = data[0];
...
void addScore(uint8_t data[]) {
	...
	scoreIncrement.scoreBytes[0] = data[3];
	scoreIncrement.scoreBytes[1] = data[2];
	scoreIncrement.scoreBytes[2] = data[1];
	scoreIncrement.scoreBytes[3] = data[0];
...
void sendBrightness(uint8_t priority) {
	CAN_MSG_OBJ transmitObj;
	transmitObj.mask = 0;
	transmitObj.mode_id = BUILD_ARB_FIELD(priority, 1, boardAddress, 0x04, 0x00, 0x03);
	transmitObj.dlc = 1;
...
void sendScoreTriggering(uint8_t priority) {
	CAN_MSG_OBJ transmitObj;
	transmitObj.mask = 0;
	transmitObj.mode_id = BUILD_ARB_FIELD(priority, 1, boardAddress, 0x04, 0x00, 0x04);
	transmitObj.dlc = 1;
